...
class Scene{
    ...
    void testChangementNiveau(GameObject* map, GameObject* obj){
        ...
        if(niveau==1){
            ...
            if(obj->centreEspace[0]>=minX && obj->centreEspace[0]<=maxX && obj->centreEspace[2]>=minZ && obj->centreEspace[2]<=maxZ && obj->centreEspace[1]<=15){
    ...
    void sautIA(GameObject* obj){
        if(obj->nbCollision>0 && difftime(time(NULL),obj->timerSautMario)>0){
            if(obj->collisions[obj->nbCollision]->isIA){
